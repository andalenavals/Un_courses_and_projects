...
private:
  ...
  double Fxold1,Fxold2,Fyold1,Fyold2;
public:
  void Inicie(double m0,double R0,double x0,double y0,double Vx0,double Vy0);
...
void Cuerpo::Inicie(double m0,double R0,double x0,double y0,double Vx0,double Vy0){
  m=m0; R=R0; x=x0; y=y0; Vx=Vx0; Vy=Vy0;
}
...
void Cuerpo::Arranque(double dt){
    ...
    float umass = 1.0/m;
    CalculeFuerza();
    xa=x; ya=y; Vxa=Vx; Vya=Vy; Fxa=Fx; Fya=Fy;
    //Predictor
