...
void Cuerpo::Dibujese(double t, int i, double et, double ec, double ep, int NoClusters, int N1){
  if(i==0)
    cout<<", "<<r.x()<<"+"<<R<<"*cos(t),"<<r.y()<<"+"<<R<<"*sin(t) w l lc 1 lw 3 t 't="<<t<<"'";
  else if(i==1)
    cout<<", "<<r.x()<<"+"<<R<<"*cos(t),"<<r.y()<<"+"<<R<<"*sin(t) w l lc 1 lw 3 t 'E_T="<<et<<"'";
  else if(i==2)
    cout<<", "<<r.x()<<"+"<<R<<"*cos(t),"<<r.y()<<"+"<<R<<"*sin(t) w l lc 1 lw 3 t 'E_K="<<ec<<"'";
  else if(i==3)
    cout<<", "<<r.x()<<"+"<<R<<"*cos(t),"<<r.y()<<"+"<<R<<"*sin(t) w l lc 1 lw 3 t 'E_P="<<ep<<"'";
  else if(i==4)
    cout<<", "<<r.x()<<"+"<<R<<"*cos(t),"<<r.y()<<"+"<<R<<"*sin(t) w l lc 1 lw 3 t 'clusters= "<<NoClusters<<"'";
  else if(i<N1 && i>4)
    cout<<", "<<r.x()<<"+"<<R<<"*cos(t),"<<r.y()<<"+"<<R<<"*sin(t) w l lc 1 lw 3 notitle";
  else 
...
int main(void){
  ...
  vector3D V1; V1.cargue(0.3,0,0);
  vector3D V2; V2.cargue(-0.3,0,0);
  ...
  NUCLEOS.Estabilizar( Nucleon1 ,N1,r1);  NUCLEOS.Estabilizar( Nucleon2,N2,r2);
  NUCLEOS.DeleVelocidad(Nucleon1,N1,V1);  NUCLEOS.DeleVelocidad(Nucleon2,N2,V2);
